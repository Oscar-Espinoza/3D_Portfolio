...
const App = () => {
  ...
  return (
    <>
      ...
      <BrowserRouter>
          {/* <Navbar /> */}
        <div className="relative z-0 bg-primary grid grid-cols-1 md:grid-cols-12 px-4" id='content-container'>
          <Hero />
          <div className="col-span-12 md:col-span-8 lg:col-span-9 flex flex-col gap-20 md:pt-24 md:pl-6">
            <About />
            <Projects />
            <Experience />
            {/* <Tech /> */}
